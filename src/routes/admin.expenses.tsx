    ...
    <div>
      ...
      <div className="bg-white rounded-3xl p-5 mb-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-6 gap-2">
          ...
          <input type="number" placeholder="Сумма ₽" value={(draft.amount || "") === 0 || (draft.amount || "") === "0" ? "" : (draft.amount || "")} onChange={(e) => setDraft({ ...draft, amount: Number(e.target.value) })} className="px-3 py-2 rounded-xl border" />
