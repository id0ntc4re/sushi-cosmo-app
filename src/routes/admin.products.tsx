      ...
      {editing && (
        <Modal onClose={() => setEditing(null)} title={editing.id ? "Редактировать товар" : "Новый товар"}>
          <div className="grid md:grid-cols-2 gap-3">
            ...
            <Field label="Цена*"><input placeholder="0" type="number" className={inp} value={(editing.price ?? 0) || ""} onChange={(e) => setEditing({ ...editing, price: Number(e.target.value) })} /></Field>
            ...
            <Field label="Сортировка"><input placeholder="0" type="number" className={inp} value={(editing.sort_order ?? 0) || ""} onChange={(e) => setEditing({ ...editing, sort_order: Number(e.target.value) })} /></Field>
