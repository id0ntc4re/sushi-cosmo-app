        ...
        <div className="bg-white rounded-3xl p-6 mb-6">
          ...
          <div className="border-t pt-4 flex items-end gap-3">
            <label className="flex-1">
              ...
              <input placeholder="0" type="number" value={(closeCash) || ""} onChange={(e) => setCloseCash(Number(e.target.value))}
        ...
        <div className="bg-white rounded-3xl p-6 mb-6">
          ...
          <div className="flex gap-3 items-end">
            <label className="flex-1">
              ...
              <input placeholder="0" type="number" value={(openCash) || ""} onChange={(e) => setOpenCash(Number(e.target.value))}
                className="w-full px-3 py-2 rounded-xl border" />
            </label>
