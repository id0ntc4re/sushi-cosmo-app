    ...
    <div className="min-h-screen bg-white text-foreground">
      ...
      <section className="mx-auto max-w-[1280px] px-3 sm:px-6 mt-6 sm:mt-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
          {[
            { Icon: Truck, title: "Бесплатно от 700 ₽", text: "Доставим в течение 80 минут" },
      ...
      <section id="menu" className="mx-auto max-w-[1280px] px-3 sm:px-6 mt-8 sm:mt-12 scroll-mt-32 md:scroll-mt-40">
        ...
        {/* category pills */}
        <div className="scrollbar-fancy flex gap-2 overflow-x-auto py-2.5 mb-6 sm:mb-8 -mx-3 sm:-mx-6 px-3 sm:px-6 sticky top-24 md:top-28 bg-background/95 backdrop-blur z-30">
          <button
