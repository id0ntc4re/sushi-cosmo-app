  ...
  return (
    <div className="min-h-screen bg-white text-foreground">
      ...
      <section id="menu" className="mx-auto max-w-[1280px] px-3 sm:px-6 mt-8 sm:mt-12 scroll-mt-32 md:scroll-mt-40">
        ...
        {/* category pills */}
        <div className="scrollbar-fancy flex gap-2 overflow-x-auto pt-3 pb-2.5 mb-6 sm:mb-8 -mx-3 sm:-mx-6 px-3 sm:px-6 sticky top-28 md:top-32 bg-background/95 backdrop-blur z-30">
          <button
